...
(function(){
					...
					linktg.href="/swete-git/swete-admin/index.php?-action=css&--id=Background-219faa1e11cf8ba14d9a1002f31be20d";
					linktg.title="Styles";
...
//START swete/actions/batch_google_translate.js
if ( typeof(window.__xatajax_included__['swete/actions/batch_google_translate.js']) == 'undefined'){window.__xatajax_included__['swete/actions/batch_google_translate.js'] = true;
/**
 * SWeTE Server: Simple Website Translation Engine
 * Copyright (C) 2012  Web Lite Translation Corp.
 * 
...
//START xataface/Comet.js
if ( typeof(window.__xatajax_included__['xataface/Comet.js']) == 'undefined'){window.__xatajax_included__['xataface/Comet.js'] = true;
...
//END swete/actions/batch_google_translate.js

}

//START Dataface/ResultList.js
if ( typeof(window.__xatajax_included__['Dataface/ResultList.js']) == 'undefined'){window.__xatajax_included__['Dataface/ResultList.js'] = true;

require(DATAFACE_URL+'/js/ajax.js');require(DATAFACE_URL+'/js/Dataface/Record.js');function Dataface_ResultList(){}
...
//END Dataface/ResultList.js

}

//START list.js
if ( typeof(window.__xatajax_included__['list.js']) == 'undefined'){window.__xatajax_included__['list.js'] = true;
