...
[swete_show_page_strings]
    condition="$record and $query['-table'] == 'webpage_status'"
    url_condition="$record"
    category=record_actions
    label="Show Strings"
    ;target="_blank"
    url="{$record->getUrl('-action=swete_translate_page')}"
    
[swete_show_page_untranslated_strings]
    condition="$record and $query['-table'] == 'webpage_status'"
    url_condition="$record"
    category=record_actions
    label="Show Untranslated Strings"
    ;target="_blank"
    url="{$record->getUrl('-action=swete_translate_page')}&--untranslated-only=1"
    
[swete_app]
    category=management_actions
    url="app"
    label="SWeTE App"
    description="Open the simplified administration console"
