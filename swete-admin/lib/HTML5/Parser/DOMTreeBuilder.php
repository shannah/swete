...
class DOMTreeBuilder implements EventHandler {
  ...
  public function __construct($isFragment = FALSE, \StdClass $params = null) {
    $this->params = $params;
    ...
    if ( isset($this->params->decorateDocument) and is_callable($this->params->decorateDocument) ){
        $func = $this->params->decorateDocument;
        $func($this->doc);
    }
